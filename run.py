...
flags.DEFINE_string('checkpoint_path', '/home/jovyan/clrs-master/clrs-master/CLRS30/CLRS30',
                    'Path in which checkpoints are saved.')
flags.DEFINE_string('dataset_path', '/home/jovyan/clrs-master/clrs-master/CLRS30/CLRS30',
...
def create_samplers(
  ...
  for algo_idx, algorithm in enumerate(algorithms):
    ...
    with tf.device('/cpu:0'):
      ...
      # test_args = dict(sizes= [np.amax(train_lengths)],
      #                  split='test',
      #                  batch_size=test_batch_size,
      #                  multiplier=2 * mult,
      #                  randomize_pos=False,
